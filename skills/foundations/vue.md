---
name: brandsync-foundations-vue
description: BrandSync theme engine for Vue 3 — CSS custom properties imported globally with a useTheme composable for dark mode toggling.
version: 1.2
---
