---
name: brandsync-foundations-web
description: BrandSync theme engine for web projects using CSS custom properties directly — React (CSS vars), Vue 3, Angular without Material theming, and plain HTML.
version: 1.2
---
...
"styles": ["brandsync-tokens/tokens.css", "src/styles.scss"]
```

**Plain HTML:**
```html
<link rel="stylesheet" href="/node_modules/brandsync-tokens/tokens.css">
```
...
Version: 1.3
Stack: Web (React CSS vars, Vue 3, Angular CSS vars, plain HTML)
