---
name: brandsync-foundations-swiftui
description: BrandSync theme engine for SwiftUI — typed Swift constants with BrandSyncTheme environment wrapper and dark mode via colorScheme.
version: 1.2
---
