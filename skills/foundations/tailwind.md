---
name: brandsync-foundations-tailwind
description: BrandSync theme engine for Tailwind CSS — maps semantic token names to CSS variable references in tailwind.config.ts.
version: 1.2
---
